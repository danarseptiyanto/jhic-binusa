                ...
                <nav className="hidden items-center gap-[10px] md:flex">
                    {menus.map((menu) => (
                        <button
                            ...
                            className="rounded-full px-[16px] py-[6px] text-[15px] font-medium text-gray-700 transition-all duration-300 hover:bg-[#BFDBFE] hover:font-semibold hover:text-[#1E3A8A]"
                        >
                            {menu}
                        </button>
                    ))}
                ...
                <nav className="mt-10 flex flex-col items-start gap-2 px-6">
                    {menus.map((menu) => (
                        <button
                            ...
                            className="w-full border-b border-gray-100 py-3 text-left text-[24px] font-medium text-gray-700 transition-all duration-300 hover:font-semibold hover:text-[#1E3A8A]"
                        >
                            {menu}
                        </button>
                    ))}
